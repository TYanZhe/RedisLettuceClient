...
/**
 * 摘自https://www.cnblogs.com/LiuYanYGZ/p/9495504.html
 */
public class ServerTabbedPaneUI extends BasicTabbedPaneUI {
    ...
    public ServerTabbedPaneUI(String bgColorHex, String frontColorHex){
...
//      }
    ...
    private class RollOverListener extends MouseAdapter implements MouseMotionListener{
        @Override
